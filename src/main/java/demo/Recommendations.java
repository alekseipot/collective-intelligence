...
import com.docler.examles.chapter2.KeyScore;
...
public class Recommendations {
    ...
    public static void main(String[] args) {
        System.out.println("=========================Top recommenders for Aleksei=========================");
        System.out.println("\"Aleksei\" top 3 recommenders (Pearson): " + topMarchers(personToMovie, "Aleksei", 5, "Pearson"));
        System.out.println("\"Aleksei\" top 3 recommenders (Euclidean): " + topMarchers(personToMovie, "Aleksei", 5, "Euclidean"));
        System.out.println("=========================Top recommenders for Aleksei=========================");

        System.out.println("=========================Recommendations for Aleksei=========================");
        System.out.println("\"Aleksei\" Recommendations with Pearson algorithm: " + getUserBasedRecommendations(personToMovie, "Aleksei", "Pearson"));
        System.out.println("\"Aleksei\" Recommendations with Euclidean algorithm: " + getUserBasedRecommendations(personToMovie, "Aleksei", "Euclidean"));
        System.out.println("=========================Recommendations for Aleksei=========================");
        ...
        System.out.println("=========================Invite to a premier of Just My Luck=========================");
        System.out.println("\"Just My Luck\" Recommendations to invite: " + getUserBasedRecommendations(movieToPerson(personToMovie), "Just My Luck", "Pearson"));
        System.out.println("=========================Invite to a premier of Just My Luck=========================");

        System.out.println("=========================Calculate item similarity=========================");
        Map<String, List<KeyScore>> itemsSim = calculateSimilarItems(personToMovie, 5);
        System.out.println("Similarity matrix: " + itemsSim);
        System.out.println("=========================Calculate item similarity=========================");

        System.out.println("=========================Item-based recommendations for Aleksei=========================");
        System.out.println("\"Aleksei\" Recommendations with item-based algorithm: " + getItemBasedRecommendations(personToMovie, itemsSim, "Aleksei", "Pearson"));
        System.out.println("=========================Item-based for Aleksei=========================");
    ...
    public static Map<String, List<KeyScore>> calculateSimilarItems(Map<String, Map<String, Double>> recommendations, Integer topN) {
        ...
        movieToPerson.keySet().parallelStream().forEach(movie -> {
            ...
            List<KeyScore> scores = topMarchers(movieToPerson, movie, topN, "Euclidean");
